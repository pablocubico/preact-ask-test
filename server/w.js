(function () {
  ...
  function innerDiffNode(dom, vnode, context) {
  		...
  		for (var _i = 0; _i < vlen; _i++) {
  			...
  			if (keyedLen) {
  				var attrs = vchild.attributes,
  				    _key = attrs && attrs.key;
  				if (!empty(_key) && hasOwnProperty.call(keyed, _key)) {
  					_child = keyed[_key];
  					keyed[_key] = null;
  					keyedLen--;
  				}
  			...
  			_child = diff(_child, vchild, context);

  			if (dom.childNodes[_i] !== _child) {
  				var _c = _child.parentNode !== dom && _child._component,
  				    next = dom.childNodes[_i + 1];
  				if (_c) deepHook(_c, 'componentWillMount');
  				if (next) {
  					dom.insertBefore(_child, next);
  				} else {
  					dom.appendChild(_child);
  				}
  				if (_c) deepHook(_c, 'componentDidMount');
  			}
  		}
  	}
  	...
  	if (keyedLen) {
  		...
  		for (var _i2 in keyed) {
  			if (hasOwnProperty.call(keyed, _i2) && keyed[_i2]) {
  ...
  var Rating = function (_Component) {
    ...
    function Rating(props, context) {
      ...
      var _this = babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(Rating).call(this, props, context));
    ...
    babelHelpers.createClass(Rating, [{
      ...
      value: function getStyles() {
        return babelHelpers.extends({}, styles.base, this.props.isValid ? styles.valid : styles.error);
      }
    }, {
      key: "onHover",
      value: function onHover(i, e) {
      ...
      key: "getTokenStyle",
      value: function getTokenStyle(i) {
        return babelHelpers.extends({}, styles.token, i < this.state.hovering ? styles.hovering : {});
      }
    }, {
      key: "getTokens",
      ...
      value: function render() {
        ...
        return h$1(
          "div",
          { style: styles.base, onMouseOut: this.onMouseOut.bind(this) },
          this.getTokens().map(function (token) {
            return token;
          }),
          h$1(
            "h2",
